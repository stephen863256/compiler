...
void Function::set_instr_name() {
   ...
   //for (auto &bb1 : basic_blocks_) {
    //    LOG_DEBUG << "set bb name222222222222:wwww " << bb1.get_name();
  //  }
    for (auto &bb1 : basic_blocks_) {
      //  LOG_DEBUG << "set bb name:wwww " << bb1.get_name();
        auto bb = &bb1;
        if (seq.find(bb) == seq.end()) {
         ...
         //for (auto &instr : bb->get_instructions()) {
           // LOG_DEBUG << "set instr name11111111: " << instr.print();
         //}
        for (auto &instr : bb->get_instructions()) {
          //  LOG_DEBUG << "set instr name: " << instr.print();
